...
description: >
  ...
  and the lazy defaults to question. Use when choosing or changing how a game looks or
  feels: HUD styling, palette declaration, font pairing, juice, menus, and death
  screens. For the technical contract and block bindings, use frogoe-core.
---
